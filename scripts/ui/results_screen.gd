...
func _build_grade_bar(data: Dictionary, pos: Vector2) -> void:
	...
	var grades := [
		[data.get("perfects", 0), Judgment.get_grade_color(Judgment.GRADE_PERFECT)],
		[data.get("greats", 0), Judgment.get_grade_color(Judgment.GRADE_GREAT)],
		[data.get("goods", 0), Judgment.get_grade_color(Judgment.GRADE_GOOD)],
		[data.get("bads", 0), Judgment.get_grade_color(Judgment.GRADE_BAD)],
		[data.get("misses", 0), Judgment.get_grade_color(Judgment.GRADE_MISS)],
	]
